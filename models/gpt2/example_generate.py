...
def test_maxlikely_hello():
    ids = tknzr.encode("Hello, I'm sorry, but I'm not sure if you're aware of this")
    for l in range(1, len(ids) + 1):
        print(tknzr.decode(ids[:l]), end=" | ")
        print(tknzr.decode(generate_text(params, ids[:l], 100)))


if __name__ == "__main__":
    ids = tknzr.encode("Hello, I'm sorry, but I'm not sure if you're aware of this")
    print(f"ids={ids}")
    generate_text(params, ids, 0)
